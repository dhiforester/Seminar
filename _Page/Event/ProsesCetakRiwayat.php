    ...
    <html>
        ...
        <body>
            ...
            <table class="data" width="100%">
                <tr>
                    <td align="text-center"><b>No</b></td>
                    <td align="text-center"><b>Tanggal/Waktu</b></td>
                    <td align="text-center"><b>Nama User</b></td>
                    <td align="text-center"><b>Keterangan</b></td>
                </tr>
                <?php
                    if(empty($jml_data)){
                        echo '<tr>';
                ...
                ?>
                    <tr>
                        ...
                        <td align="left"><?php echo "$Tanggal <br> <small>$Waktu</small>"; ?></td>
