        ...
        <body>
            ...
            <table class="data" width="100%">
                <tr>
                    ...
                    <td align="center"><b>Unit/Instansi</b></td>
                    <td align="center"><b>Email/Kontak</b></td>
                    <td align="center"><b>In/Eks</b></td>
                ...
                ?>
                    <tr>
                        ...
                        <td align="left"><?php echo "$unit_instansi"; ?></td>
                        <td align="left"><?php echo "<b>$email</b><br><small>Kontak:$kontak</small>"; ?></td>
                        <td align="center"><?php echo "$LabelExin"; ?></td>
                        <td align="center"><?php echo "$LabelAbses"; ?></td>
                    </tr>
                <?php $no++;}} ?>
            </table>
        </body>
