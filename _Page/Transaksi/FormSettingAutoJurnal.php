        ...
        <select name="trans_account1" id="trans_account1" class="form-control">
            <?php
                ...
                if(empty($id_mitra)){
                    ...
                    $QryAkun= mysqli_query($Conn, "SELECT*FROM akun_perkiraan WHERE id_mitra='$SessionIdMitra' ORDER BY nama");
                }
...
<div class="row">
    <div class="col-md-6 mb-3">
        <label for="trans_account3">Akun Transaksi</label>
        <select name="trans_account3" id="trans_account3" class="form-control">
            <?php
                echo '<option value="">Pilih</option>';
                if(empty($id_mitra)){
                    $QryAkun= mysqli_query($Conn, "SELECT*FROM akun_perkiraan ORDER BY nama");
                ...
                while ($DataAkun=mysqli_fetch_array($QryAkun)) {
                    ...
                    $LevelTerbawah = mysqli_num_rows(mysqli_query($Conn, "SELECT*FROM akun_perkiraan WHERE kd$level='$kode'"));
                    if($LevelTerbawah=="1"){
                        if($trans_account3==$id_perkiraan){
                            echo '<option selected value="'.$id_perkiraan.'">'.$nama_perkiraan.' ('.$saldo_normal.')</option>';
                        }else{
                            echo '<option value="'.$id_perkiraan.'">'.$nama_perkiraan.' ('.$saldo_normal.')</option>';
                        }
    ...
    <div class="col-md-6 mb-3">
        <label for="cash_account3">Akun Kas</label>
        <select name="cash_account3" id="cash_account3" class="form-control">
            <?php
                echo '<option value="">Pilih</option>';
                if(empty($id_mitra)){
                    $QryAkun= mysqli_query($Conn, "SELECT*FROM akun_perkiraan ORDER BY nama");
...
<div class="row">
    <div class="col-md-6 mb-3">
        <label for="debt_account3">Akun Utang</label>
        <select name="debt_account3" id="debt_account3" class="form-control">
            <?php
                echo '<option value="">Pilih</option>';
                if(empty($id_mitra)){
                    $QryAkun= mysqli_query($Conn, "SELECT*FROM akun_perkiraan ORDER BY nama");
    ...
    <div class="col-md-6 mb-3">
        <label for="receivables_account3">Akun Piutang</label>
        <select name="receivables_account3" id="receivables_account3" class="form-control">
            <?php
                echo '<option value="">Pilih</option>';
                if(empty($id_mitra)){
                    $QryAkun= mysqli_query($Conn, "SELECT*FROM akun_perkiraan ORDER BY nama");
                ...
                while ($DataAkun=mysqli_fetch_array($QryAkun)) {
                    ...
                    $LevelTerbawah = mysqli_num_rows(mysqli_query($Conn, "SELECT*FROM akun_perkiraan WHERE kd$level='$kode'"));
                    if($LevelTerbawah=="1"){
                        if($receivables_account3==$id_perkiraan){
                            echo '<option selected value="'.$id_perkiraan.'">'.$nama_perkiraan.' ('.$saldo_normal.')</option>';
                        }else{
                            echo '<option value="'.$id_perkiraan.'">'.$nama_perkiraan.' ('.$saldo_normal.')</option>';
                        }
