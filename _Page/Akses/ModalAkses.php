...
<div class="modal fade" id="ModalUpdateStatusAkses" tabindex="-1">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <form action="javascript:void(0);" id="ProsesUpdateStatusAkses">
                <div class="modal-header bg-secondary">
                    <h5 class="modal-title text-light"><i class="bi bi-person-plus"></i> Update Status Akses</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body" id="FormUpdateStatusAkses">
