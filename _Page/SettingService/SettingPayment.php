                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12 text-right">
                                <small class="text-info">
                                    Untuk memperoleh Call Back Dari payment gateway, silahkan lakukan pengaturan secara manual sebagai berikut:
                                    <ul>
                                        <li>
                                            Pada file <code>Notifikasi.php</code> yang ada pada payment gateway. Ubah parameter <code>$isProduction</code> dan <code>$serverKey</code> sesuai informasi service.
                                        </li>
                                        <li>
                                            Arahkan <i>Call Back pada akun payment gateway anda pada file <code>Notifikasi.php</code> tersebut</i>
                                        </li>
                                    </ul>
                                </small>
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12 text-right" id="NotifikasiSimpanSettingPayment">
                                <small class="text-dark">Pastikan pengaturan payment gateway sudah benar.</small>
                            </div>
                        </div>
                    </div>
                    <div class="card-footer">
                        ...
                        <button type="button" class="btn btn-md btn-info" data-bs-toggle="modal" data-bs-target="#ModalTestSnapToken">
                            <i class="bi bi-arrow-repeat"></i> Test Snap Token
                        </button>
                    </div>
                </div>
            </form>
