                        ...
                        <?php
                            if(empty($jml_data)){
                                ...
                                while ($data = mysqli_fetch_array($query)) {
                                    ...
                                    $datetime_api_key=date('d/m/y H:i',$datetime_api_key);
                                ?>
                            <tr>
                                ...
                                <td class="text-left" align="left">
                                    <small class="credit">
                                        <?php 
                                            echo "<b>$title_api_key</b><br>";
                                            echo "Ket: $description_api_key";
                                        ?>
                                    </small>
                                    <br>
                                </td>
                                ...
                                <td align="center">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#ModalEditApiKey" data-id="<?php echo "$id_setting_api_key,$keyword,$batas,$ShortBy,$OrderBy,$page,$keyword_by"; ?>">
                                            <i class="bi bi-pencil-square"></i>
                                        </button>  
                                        <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#ModalDeleteApiKey" data-id="<?php echo "$id_setting_api_key,$keyword,$batas,$ShortBy,$OrderBy,$page,$keyword_by"; ?>">
                                            <i class="bi bi-x"></i>
                                        </button>   
                                    </div>
