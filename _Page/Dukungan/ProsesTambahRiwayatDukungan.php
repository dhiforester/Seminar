<?php
    ...
    //Validasi id_dukungan tidak boleh kosong
                ...
                if(empty($_POST['jam'])){
                    ...
                    if(empty($_POST['kategori_kerja'])){
                        ...
                        if(empty($_POST['keterangan'])){
                            ...
                            $tanggal="$tanggal $jam";
                            //Cek apakah dukungan sudah di response atau belum
                                    ...
                                    if($ValidasiGambar!=="Valid"){
                                        ...
                                        if($Input){
                                            if($status_dukungan=="Request"){
                                                //Update status dukungan
                                                $UpdateDukungan = mysqli_query($Conn,"UPDATE dukungan SET 
                                                    tanggal_response='$tanggal',
                                                    status_dukungan='Response'
                                                ...
                                                if($UpdateDukungan){
                                                    ...
                                                    echo '<small class="text-danger">Terjadi kesalahan pada saat melakukan update status sukungan</small>';
                                                }
                                            }else{
                                                $KategoriLog="Input Riwayat Kerja";
                                                $KeteranganLog="Input Riwayat Kerja Berhasil";
