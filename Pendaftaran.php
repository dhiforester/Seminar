                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="javascript:void(0);" class="row g-3" id="ProsesPendaftaran" autocomplete="off">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="input-group has-validation">
                                                    <input type="file" name="image_akses" class="form-control" id="image_akses" required>
                                                </div>
                                                <small>Gunakan Foto Yang Jelas Untuk Mempermudah Admin Melakukan Validasi</small>
                                            </div>
                                            <div class="col-md-6">
